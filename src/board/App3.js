...
class App3 extends Component {
        ...
        boards: [
            {
                ...
                brdtitle: 'If you intends to live then you die',
                brddate: new Date()
            }, {
                brdno: 2,
                brdwriter: 'So SiNo',
    ...
    render() {
        ...
        // const list = boards.map(function(row){     return row.brdno + row.brdwriter ;
        // });
        return (
            <div>
...
class BoardItem extends Component {
    render() {
        return (
            <tr>
                <td>
                    {this.props.row.brdno}
                </td>
                <td>
                    {this.props.row.brdtitle}
                </td>
                <td>
                    {this.props.row.brdwriter}
                </td>
                <td>
                    {
                        this
